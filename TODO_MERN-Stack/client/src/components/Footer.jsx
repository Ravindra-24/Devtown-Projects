    ...
    <div>
      <>
        ...
        <footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600">
          ...
          {/*Copyright section*/}
          <div className="bg-neutral-300 p-2 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
            © 2023 Copyright:
            <a className="text-neutral-800 dark:text-neutral-400 text-bold">
              TODO
            </a>
          </div>
        </footer>
